        ...
        <div className='flex-[2] flex flex-col gap-[40px]'>
          <div>
            ...
            <div className='mt-[20px] flex flex-row flex-wrap gap-[14px]'>
              <div className='w-[80px] h-[80px] flex items-center justify-center rounded-full cursor-pointer'>
                <img src={thirdweb} alt='user' className='w-[100%] h-[100%] object-contain'/>
              </div>

              <div>
                <h4 className='font-epilogue font-normal text-[15px] text-[#00000] mt-[18px] break-all'>{state.owner}</h4>
          ...
          <div>
            <h4 className="font-epilogue font-semibold text-[18px] text-[#00000] bg-[#FEDE6D] uppercase">Donators</h4>

              <div className="mt-[20px] flex flex-col gap-4">
                {donators.length > 0 ? donators.map((item, index) => (
                  <div key={`${item.donator}-${index}`} className="flex justify-between items-center gap-4">
                    <p className="font-epilogue font-normal text-[14px] text-[#00000] leading-[26px] break-ll">{index + 1}. {item.donator}</p>
                    <p className="font-epilogue font-normal text-[14px] text-[#00000] leading-[26px] break-ll">{item.donation}</p>
                  </div>
                )) : (
