...
const Navbar = () => {
  ...
  return (
    <div className='flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6'>
      <div className='lg:flex-1 flex flex-row max-w-[458px] py-2 pl-4 pr-2 h-[52px] bg-[#FFF8E7] rounded-[100px]'>
        <input type='text' placeholder='Search for campaigns' className='flex w-full font-epilogue font-normal text-[14px] placeholder:text-[#131212] text-white bg-transparent outline-none'/>
      ...
      <div className='sm:flex hidden flex-row justify-end gap-4 border-[#FFF8E7]'>
        <CustomButton 
          btnType="button"
          title={address ? 'Create a campaign' : 'Connect'}
          styles={address ? 'bg-[#FFF8E7]' : 'bg-[#8c6dfd]'}
          handleClick={() => {
